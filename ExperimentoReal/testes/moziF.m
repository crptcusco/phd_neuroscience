...
line2 = '\n \n \n O objetivo deste Ã© investigar os nÃ­veis de aquisiÃ§Ã£o de habilidades';
...
line3= '\n referente no teclado o mais rápido possí­vel.';
...
vet = [1 1 2 2 3 3];
seq = randperm(6); 
rt1 = zeros(1, length(seq))-0; %tempo de resposta (tempo de reação)
